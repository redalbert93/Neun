        ...
        <div class="section subnav post-content-form">
          ...
          <xsl:if test="root/post/Contenuto">
            ...
            <div class="preview">
              ...
              <div class="alert danger">
                ATTENZIONE: Questa è un anteprima del tuo articolo. Ricorda che devi salvare l'articolo tramite il form sottostante. Questa versione non è salvata.
              </div>
          ...
          <form  method="post" action="">
            ...
            <fieldset>
              ...
              <textarea rows="4" cols="50" aria-describedby="help" name="ContenutoPlain" id="comment">
              ...
              <input aria-describedby="meaning" type="submit" name="submit" value="Iniva articolo" class="button"/>          
